...
export function GradientMesh(props) {
  ...
  useEffect(() => {
    ...
    // Enable alpha and antialias for better rendering
    const renderer = new Renderer({ alpha: true, antialias: true });
    const gl = renderer.gl;
    // Set clear color to transparent so underlying page shows if shader fails
  ...
  return (
    <div
      ...
      style={{ width: "100%", height: "100%", position: "absolute", overflow: "hidden", ...props.style }}
    />
  );
}
