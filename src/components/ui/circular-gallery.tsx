  ...
  ({ items, className, radius = 600, autoRotateSpeed = 0.02, onItemClick, ...props }, ref) => {
    ...
    useEffect(() => {
      const handleScroll = () => {
        ...
        // Map scroll progress (0-1) to multiple rotations for a more dynamic feel
      ...
      >
        ...
        >
          {items.map((item, i) => {
            ...
            const opacity = Math.max(0.3, 1 - (normalizedAngle / 120)); // Adjusted for smoother fade
            ...
            return (
              <div
                ...
                className="absolute w-[240px] h-[320px] md:w-[320px] md:h-[420px]"
                style={{
